...
const mixin = finder.sync([__dirname.split("/node_modules/rectangular")[0] + "/dev/app/**/*.mixin.json"]);
const data = finder.sync([__dirname.split("/node_modules/rectangular")[0] + "/dev/app/**/*.data.json"]);
