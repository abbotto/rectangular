...
const sourceJSON = projectPath(finder.sync(require(__dirname + "/../../../../dev/asset/source.scss.json")));
const vendorJSON = projectPath(require(__dirname + "/../../../../dev/asset/vendor.scss.json"));
