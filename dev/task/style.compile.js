...
const sourceJSON = projectPath(finder.sync(require(__dirname + "/../../tmp/dev/asset/source.scss.json")));
const vendorJSON = projectPath(require(__dirname + "/../../tmp/dev/asset/vendor.scss.json"));
